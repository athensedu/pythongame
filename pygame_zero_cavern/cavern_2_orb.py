...
# by Athensoft - added a level
LEVELS = [["XXXXXXXXXXXXXXXXXX    XXXXXX",
           "", "", "", "",
           "   XXXXXXX    XXXXXXXXXXX   ",
           "", "", "",
...
class Fruit(GravityActor):
    ...
    def __init__(self, pos, trapped_enemy_type=0):
        ...
        if trapped_enemy_type == Robot.TYPE_NORMAL:
            ...
            # If trapped_enemy_type is 1, it means this fruit came from bursting an orb containing the more dangerous
            # type of enemy. In this case there is a chance of getting an extra help or extra life power up
